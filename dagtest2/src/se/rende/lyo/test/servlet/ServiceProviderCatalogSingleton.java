...
public class ServiceProviderCatalogSingleton
{
    ...
    static
    {
        try
        {
            ...
            serviceProviderCatalog.setTitle("dagtest");
            serviceProviderCatalog.setDescription("dags test catalog");
            serviceProviderCatalog.setPublisher(new Publisher("dagtestpublisher", "dagtestpublisher"));
            serviceProviderCatalog.getPublisher().setIcon(new URI(""));
        }
 ...
 */
    ...
    protected static void initServiceProviders (HttpServletRequest httpServletRequest)   
    {
		try {
	        ...
	        ServiceProviderInfo [] serviceProviderInfos = DagtestManager.getServiceProviderInfos(httpServletRequest);
	        ...
	        for (ServiceProviderInfo serviceProviderInfo : serviceProviderInfos) {
		        ...
		        if (! serviceProviders.containsKey(identifier)) {
					...
					String title = "dagtestprovider: " + serviceProviderName + "(" + identifier + ")";
					String description = "dags test provider: " + serviceProviderName + "(" + identifier + ")";
